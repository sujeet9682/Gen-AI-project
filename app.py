import sys
sys.path.append('/Users/sujeetsair/Documents/mini project/Gen-AI-project/.venv/lib/python3.9/site-packages')
...
def handle_userinput(user_question):
    if st.session_state.conversation is None:
        st.error("Conversation chain is not initialized yet. Please process the PDFs first.")
        return
